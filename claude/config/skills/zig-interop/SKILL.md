...
- **Zig talking to Rust, Swift, or ObjC** -- [Cross-Language via C ABI](#cross-language-via-c-abi) and `cross_language_abi.zig`
...
- **zig-gobject** -- GObject introspection bindings via comptime
- **allyourcodebase** -- Community collection of C library build.zig packages
