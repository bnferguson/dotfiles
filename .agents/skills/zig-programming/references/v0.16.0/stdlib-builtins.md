...
This reference targets Zig 0.16.0. Read [io.md](io.md) before using filesystem, networking, process, time, entropy, or blocking synchronization APIs.
...
#### Type-creation builtins

Zig 0.16 removes `@Type`. Use the builtin for the type that you need to create:
...
Read [the 0.16 migration reference](version-differences.md#type-construction) for an example.
