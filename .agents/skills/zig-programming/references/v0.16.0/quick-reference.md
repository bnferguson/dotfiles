...
This reference targets Zig 0.16.0. For I/O, process entry points, time, entropy, or blocking synchronization, read [io.md](io.md) first.

Use the [Zig 0.16.0 language reference](https://ziglang.org/documentation/0.16.0/) when a builtin or language rule is not covered here.
